...
section.dashb ul.portfolio-list {
  display: grid;
  gap: 12px;
}

section.dashb ul.portfolio-list li {
  margin: 0;
}

section.dashb ul.portfolio-list li a {
  display: block;
  padding: 12px 14px;
...
section.dashb ul.portfolio-list li a:hover {
  border-color: #ff7c7c;
  color: #ff7c7c;
}
